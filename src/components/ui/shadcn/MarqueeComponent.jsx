import Marquee from "../shadcn/marquee";

export function MarqueeComponent({ marqueeItems,className }) {
    ...
    return (
        <div className={`relative flex w-full flex-col items-center justify-center overflow-hidden rounded-lg ${className}`}>
